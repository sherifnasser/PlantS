...
/**
 * Added missing parameter [contentHorizontalPadding] to default [OutlinedTextField]
 *
 ...
 * @param enabled controls the enabled state of the [PlantSOutlinedTextField]. When `false`, the text field will
 * be neither editable nor focusable, the input of the text field will not be selectable,
 * visually text field will appear in the disabled UI state
 * @param readOnly controls the editable state of the [PlantSOutlinedTextField]. When `true`, the text
 ...
 * @param contentHorizontalPadding a missing parameter for default [OutlinedTextField]
 * that handle content padding if leading icon is not null
 */
@Composable
fun PlantSOutlinedTextField(
    value: String,
...
private fun IconsWithTextFieldLayout(
    ...
    Layout(
        content = {
            ...
            Box(Modifier.layoutId(TextFieldId).padding(horizontal = contentHorizontalPadding)) {
                textField()
            }
...
/**
 * Calculate the width of the [PlantSOutlinedTextField] given all elements that should be
 * placed inside
 */
...
/**
 * Calculate the height of the [PlantSOutlinedTextField] given all elements that should be
 * placed inside
 */
...
/**
 * A draw modifier to draw a border line in [PlantSOutlinedTextField]
 */
